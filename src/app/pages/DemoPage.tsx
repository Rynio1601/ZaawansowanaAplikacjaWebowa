      ...
      <div style={{ paddingTop: 100 }}>
        <div className="min-h-[60vh] flex items-center justify-center px-4">
          <div className="text-center max-w-md">
            ...
            <Link to="/rejestracja" className="inline-flex items-center gap-2 px-6 py-3 rounded-xl text-white"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="p-6 sm:p-8 rounded-2xl" style={{ background: '#0A0F1A', border: '1px solid rgba(255,255,255,0.06)' }}>
            <form onSubmit={handleSubmit}>
              ...
              <p className="text-center text-xs mt-3" style={{ color: '#334155' }}>Możesz też zacząć od razu: <Link to="/rejestracja" style={{ color: '#60A5FA' }}>14-dniowy trial za darmo</Link></p>
            </form>
          </div>
        </div>
      </div>

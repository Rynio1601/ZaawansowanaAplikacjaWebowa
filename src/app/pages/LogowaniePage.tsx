    ...
    <div style={{ paddingTop: 80, minHeight: '100vh' }} className="flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="p-6 sm:p-8 rounded-2xl" style={{ background: '#0A0F1A', border: '1px solid rgba(255,255,255,0.06)' }}>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <div className="flex justify-between mb-1.5">
                ...
                <Link to="/" className="text-xs" style={{ color: '#60A5FA' }}>Zapomniałeś hasła?</Link>
              </div>
          ...
          {/* Quick demo login */}
          <button onClick={() => navigate('/app/dashboard')} className="w-full py-3 rounded-xl text-sm transition-all"
          ...
          <p className="text-center text-xs mt-4" style={{ color: '#334155' }}>
            Nie masz konta? <Link to="/rejestracja" style={{ color: '#60A5FA' }}>Zarejestruj się za darmo</Link>
          </p>
        </div>
      </div>
    </div>

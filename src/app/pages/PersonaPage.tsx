...
export function PersonaPage({ persona }: PersonaPageProps) {
  ...
  return (
    <>
      <SeoHead 
        pageKey={`persona${persona.charAt(0).toUpperCase() + persona.slice(1)}` as any}
        title={`${data.badge} | TrainerPro`}
      ...
      <div style={{ paddingTop: 80 }}>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <div className="flex flex-wrap gap-4 mb-8">
                  <Link to="/rejestracja"
                    onClick={() => {
                      trackCTAClick(`Persona ${data.badge} Register CTA`);
                      trackRegistrationStart();
                    }}
                  ...
                  <Link to="/demo"
                    onClick={() => {
                      trackCTAClick(`Persona ${data.badge} Demo CTA`);
                      trackDemoClick();
                    }}
        ...
        <section className="py-16 text-center">
          <div className="max-w-xl mx-auto px-4">
            ...
            <Link to="/rejestracja"
              onClick={() => {
                trackCTAClick(`Persona ${data.badge} Final CTA`);
                trackRegistrationStart();
              }}

import { Link, useNavigate } from 'react-router-dom'; // Poprawiony import
        ...
        <div className="w-full max-w-md">
          ...
          <div className="p-6 sm:p-8 rounded-2xl" style={{ background: '#0A0F1A', border: '1px solid rgba(255,255,255,0.06)' }}>
            ...
            <form onSubmit={handleSubmit}>
              ...
              {step === 2 && (
                <div className="space-y-3">
                  ...
                  <button type="submit" disabled={!form.role || loading} className="w-full py-3.5 rounded-xl text-white mt-2 disabled:opacity-50"
                    style={{ background: 'linear-gradient(135deg, #2563EB, #06B6D4)', fontWeight: 700 }}>
            ...
            <p className="text-center text-xs mt-4" style={{ color: '#334155' }}>
              Masz już konto? <Link to="/logowanie" 
                onClick={() => {
                  trackCTAClick('Register Page Login CTA');
                }}
                style={{ color: '#60A5FA' }}>Zaloguj się</Link>
            </p>
